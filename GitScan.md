...
An essentially empty repository — at last inspection the `~/Git/GitScan/` directory contained only a `.claude/` folder with restricted permissions (`drwx------`) and nothing else, not even a `.git/` directory. Not really a repo at all.
