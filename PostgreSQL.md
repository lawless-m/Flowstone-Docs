...
As well as the native database. also use [[Foreign-Data-Wrapper]] to access other data sources. For instance you can import data from [[Parquet]] files or query [[MySQL]], and even [[ODBC]].
