...
Converts PDFs to images and sends them to a local Qwen2-VL inference server for extraction of headers, line items, and totals with confidence scoring. Outputs JSON, CSV, and Excel. Batch processing with retry logic, automatic archiving, and a drag-and-drop web UI. Shares GPU VRAM with [[Ollama]] and [[Charlotte]] via OOM retry and request-unload signalling. Deployed on [[Dw.RamsdenInternational.Com]].
