...
A standalone single-file HTML widget — "Finance Date Filter" — that presents a quarter / half-year / month / day picker for finance date ranges. Dark theme with a pink accent. Not a project in the usual sense; everything lives in one `date_pick_me.html` file.
