...
**URL:** [https://dw.ramsden-international.com/marvinous/](https://dw.ramsden-international.com/marvinous/)

Reads 80+ IPMI BMC sensors, SMART drive health, GPU stats, and system logs, then sends the lot to Qwen for sardonic analysis with severity ratings (OK/WATCH/CONCERN/CRITICAL). Web dashboard on port 9090 with colour-coded reports and manual collection triggers. Daily summaries consolidate and archive hourly reports. Runs as systemd timers. Deployed on [[Dw.ramsdenInternational.com]].
