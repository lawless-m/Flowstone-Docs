...
Dingo automates the creation of Food Label Declarations, Supplier Declarations, and Product Specification Declarations for imported food shipments. It pulls shipment data from a [[DBISAM]] backend via [[HTML-Data-Table]], auto-detects ingredient categories (dairy, eggs, gelatine, pork, beef) from product descriptions, and generates compliant PDF documents using pdfMake. Deployed as a static HTML app on [[Dw.ramsden-International.com]] with a vanilla JS frontend — no frameworks.
