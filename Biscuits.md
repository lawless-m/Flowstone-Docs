...
A [[csharp]] desktop tool for inspecting Power BI files — connects to a running PBI Desktop instance and identifies unused tables, measures, and columns.

**Repo:** `~/Git/Biscuits`
**Themes:** [[csharp]], [[dotnet]], [[power-bi]]
